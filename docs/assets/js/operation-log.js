(function () {
  ...
  class OperationLogPage {
    constructor(dependencies) {
      ...
      this.summaryRenderer = new OperationSummaryRenderer(dependencies.app);
      this.validationRenderer = new ValidationReportRenderer(dependencies.app);
    }
  ...
  class OperationSummaryRenderer {
    ...
    render(summary) {
      ...
      this.renderSources(sourceResults);
      this.renderHealthChecks(app.generationHealth(summary));
    }
    ...
    renderSources(sourceResults) {
      ...
      sourceResults.forEach(function (source) {
        ...
        if (source.message) main.appendChild(app.el("span", { text: source.message }));
  ...
  new OperationLogPage({ app: window.YTRank }).init();
})();
